...
ServerSocket::ServerSocket(std::string ip, int port) : ASocket(), _type(SOCK_STREAM), _protocol(0), _port(port), _ip(ip) {}
ServerSocket::ServerSocket(int port) : ASocket(), _domain(AF_INET), _type(SOCK_STREAM), _port(port) {}

ServerSocket::ServerSocket() : ASocket(), _domain(AF_INET), _type(SOCK_STREAM), _protocol(0), _port(-1) {}
